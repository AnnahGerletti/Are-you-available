  ...
  return knex('events').del()
    .then(function () {
      ...
      return knex('events').insert([
        ...
        {id: 3, eventName:'Annah and Nicks Wedding', description:'A celebration of love', rangeStart:'2020-09-01' , rangeEnd:'2020-12-01', photo:'/images/wedding.jpg' , finalStart: , finalEnd: }
      ]);
    });
};
